...
const COUNTRY_MAPPINGS: CountryMapping[] = [
  ...
  { countryName: "Suiza", cityId: "zurich" },
  { countryName: "Noruega", cityId: "oslo" },
  { countryName: "Portugal", cityId: "lisbon" },
  { countryName: "Grecia", cityId: "athens" },
  { countryName: "Países Bajos", cityId: "amsterdam" },
  { countryName: "Suecia", cityId: "stockholm" },
  { countryName: "Chile", cityId: "santiago" },
  { countryName: "Perú", cityId: "lima" },
  { countryName: "India", cityId: "new-delhi" },
  { countryName: "Sudáfrica", cityId: "johannesburg" },
  { countryName: "Nueva Zelanda", cityId: "auckland" },
  { countryName: "Austria", cityId: "vienna" },
  { countryName: "Bélgica", cityId: "brussels" },
  { countryName: "Dinamarca", cityId: "copenhagen" },
  { countryName: "Finlandia", cityId: "helsinki" },
  { countryName: "Irlanda", cityId: "dublin" },
  { countryName: "Panamá", cityId: "panama" },
  { countryName: "Costa Rica", cityId: "san-jose" },
  { countryName: "Uruguay", cityId: "montevideo" },
  { countryName: "Tailandia", cityId: "bangkok" },
  { countryName: "Indonesia", cityId: "jakarta" },
  { countryName: "Filipinas", cityId: "manila" },
  { countryName: "Malasia", cityId: "kuala-lumpur" },
  { countryName: "Vietnam", cityId: "hanoi" },
  { countryName: "Taiwán", cityId: "taipei" },
  { countryName: "Nepal", cityId: "kathmandu" },
  { countryName: "Bangladés", cityId: "dhaka" },
  { countryName: "Pakistán", cityId: "karachi" },
  { countryName: "Arabia Saudita", cityId: "riyadh" },
  { countryName: "Irán", cityId: "tehran" },
  { countryName: "Polonia", cityId: "warsaw" },
  { countryName: "República Checa", cityId: "prague" },
  { countryName: "Marruecos", cityId: "casablanca" },
  { countryName: "Kenia", cityId: "nairobi" },
  { countryName: "Nigeria", cityId: "lagos" },
  { countryName: "Bolivia", cityId: "la-paz" },
  { countryName: "Guatemala", cityId: "guatemala-city" }
];
